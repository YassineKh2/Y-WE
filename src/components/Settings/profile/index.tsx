...
type FormFields = z.infer<typeof Profile>;
...
const SettingBoxes = () => {
                  ...
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          className="w-full rounded-[7px] border-[1.5px] border-stroke bg-white py-2.5 pl-12.5 pr-4.5 text-dark [appearance:textfield] focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                          type="number"
                          pattern="[0-9]"
                          inputMode="numeric"
                          {...register("phonenumber")}
                          id="phonenumber"
                          placeholder="90 555 555"
                        />
 ...
 ac suscipit diam sem a felis. Cras sapien ex, blandit eu dui et suscipit gravida nunc. Sed sed est quis dui."
            ...
            <div className="my-5 rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
              <div className="p-7">
